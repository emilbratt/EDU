...
Chunk layout:
    ...
    CRC:
        ...
        See CRC algorithm -> https://www.libpng.org/pub/png/spec/1.2/PNG-Structure.html#CRC-algorithm

    Note: all integer fields in the PNG file format are stored in big endian order, that is, most significant byte first
</pre>
