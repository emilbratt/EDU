...
<?php
    ...
    // if already logged in, display link to main page
    if(isset($_SESSION['verified']) == true) {
        echo '
            <h3>
                Du er allerede logget inn som: '.$_SESSION['user'].'<br>
    ...
    // if not logged in but value registered in form, send to verification
